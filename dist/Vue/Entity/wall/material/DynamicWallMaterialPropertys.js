...
/*
    ...
    trailImage 贴图地址
*/
function DynamicWallMaterialPropertys(options) {
...
Object.defineProperties(DynamicWallMaterialPropertys.prototype, {
    isConstant: {
        get: function () {
            return false;
        }
...
DynamicWallMaterialPropertys.prototype.getType = function (time) {
    return MaterialType;
};

DynamicWallMaterialPropertys.prototype.getValue = function (time, result) {
...
DynamicWallMaterialPropertys.prototype.equals = function (other) {
    return this === other ||
        (other instanceof DynamicWallMaterialPropertys
...
Cesium.DynamicWallMaterialPropertys = DynamicWallMaterialPropertys;
