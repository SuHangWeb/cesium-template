import Utils from "@/common/cesium/Utils"
/**
 * 右键菜单
 */
class rightClickMenu {
    ...
    createUI(position) {
        ...
        for (let i = 0; i < this.menu.length; i++) {
            ...
            _html += `
                <div class="right-click-menu-item" style="${this.menu_item_style}">
                    ${item.label}
                </div>
            `
        }
    ...
    loadRightClick() {
        ...
        Handler.setInputAction((e) => {
            ...
            if (!this._Utils.operationDom('has', "right-click-menu")) {
                this._Utils.operationDom("append", 'cesiumContainer', this.createUI(e.position))
