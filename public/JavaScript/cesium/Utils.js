...
class Utils {
     ...
     */
    operationDom(type, NodeId, Dom, parent = false) {
        if (!parent) {
            if (type === "append") {
            ...
            if (type === "append") {
                console.log(parent)
                console.log(parent.document.getElementById(NodeId))
                parent.document.getElementById(NodeId).appendChild(Dom)
            }
            if (type === "remove") {
                parent.document.getElementById(NodeId).remove()
            }
            if (type === "has") {
                return parent.document.getElementById(NodeId)
            }
        }
    }
