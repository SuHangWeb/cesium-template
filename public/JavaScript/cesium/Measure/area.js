 ...
 * 面积
 */
class Area extends MeasureCommon {
    positions = [];
    tempPositions = [];
    vertexEntities = [];
        ...
        this.mesureResultEntity = this.viewer.entities.add({
            ...
            label: {
                text: new Cesium.CallbackProperty(e => {
                    ...
                    return "面积" + this.get_countArea(this.tempPositions) + "平方米";
                }, false),
                scale: 0.5,
    ...
    rightClickEvent() {
        ...
        this.handler.setInputAction(e => {
            if (!this.isMeasure || this.positions.length < 3) {
                ...
                this.mesureResultEntity.label.text = "总面积" + this.get_countArea(this.positions) + "平方米"
                this.measureEnd();
            }
